  ...
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
      <div className="p-4 md:p-6">
        <div className="w-48 h-7 bg-gray-200 animate-pulse mb-6" />
              ...
              <div className="md:hidden">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="w-32 h-4 bg-gray-200 animate-pulse mb-2" />
                    <div className="w-24 h-3 bg-gray-100 animate-pulse mb-3" />
                ...
                <div className="flex items-center justify-between mt-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="w-6 h-5 bg-gray-100 animate-pulse" />
                    <div className="w-7 h-7 rounded-full bg-gray-200 animate-pulse" />
                  </div>
                  <div className="w-5 h-5 bg-gray-100 animate-pulse" />
                </div>
              </div>

              <div className="hidden md:flex md:items-center md:w-full">
                <div className="w-16 h-16 bg-gray-200 rounded-lg animate-pulse mr-4 flex-shrink-0" />
                <div className="flex-1">
                  <div className="w-48 h-5 bg-gray-200 animate-pulse mb-2" />
                ...
                <div className="flex items-center space-x-3 mr-4">
                  ...
                  <div className="w-8 h-6 bg-gray-100 animate-pulse" />
                  <div className="w-8 h-8 rounded-full bg-gray-200 animate-pulse" />
                </div>
                <div className="w-8 h-8 rounded-full bg-gray-200 animate-pulse" />
              </div>
