...
export default function CheckoutProgress() {
  ...
  return (
    <>
      ...
      <div className="md:hidden rounded-lg border border-base-content/10 shadow-sm p-4 mb-4">
      ...
      <div className="hidden md:block rounded-lg border border-base-content/10 shadow-sm p-6 mb-8">
