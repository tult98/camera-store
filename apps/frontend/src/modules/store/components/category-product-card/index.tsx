    ...
    Object.entries(attrs)
      ...
      .forEach(([key, value]) => {
        if (value === true) {
          ...
          attributes.push({ label: "", value: capitalizedKey })
        } else {
  ...
  if (viewMode === "list") {
    return (
      <Link
        ...
        aria-label={`View details for ${product.title} - ${displayPrice}`}
      >
        <div className="card card-side bg-base-100 shadow-lg hover:shadow-xl transition-all duration-300 border border-base-300 hover:border-primary/20">
          ...
          <div className="card-body p-6">
            <div className="flex items-start justify-between">
              ...
              <span
                className="text-primary font-bold text-xl whitespace-nowrap"
                aria-label="Price"
              >
                {displayPrice}
              </span>
