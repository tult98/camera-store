import { type MedusaNextFunction, type MedusaRequest, type MedusaResponse } from '@medusajs/framework';
...
const staticMiddleware = (req: MedusaRequest, res: MedusaResponse, next: MedusaNextFunction) => {
