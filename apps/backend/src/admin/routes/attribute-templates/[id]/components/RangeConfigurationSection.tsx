...
export const RangeConfigurationSection = ({ index, control, errors }: RangeConfigurationSectionProps) => {
  return (
    <div className="col-span-2 mt-4 p-4 border rounded-lg bg-gray-50">
      <h4 className="font-medium mb-3 text-purple-700 flex items-center">
        Range Configuration
        <FieldWithTooltip label="" tooltip={{ ...FACET_TOOLTIPS['range_config'], color: 'purple' }} field={<span />} />
      </h4>
