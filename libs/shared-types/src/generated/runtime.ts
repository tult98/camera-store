...
export class BaseAPI {
    ...
    private async createFetchParams(context: RequestOpts, initOverrides?: RequestInit | InitOverrideFunction) {
        ...
        const initParams = {
            ...
            headers,
            body: context.body,
            ...(this.configuration.credentials && { credentials: this.configuration.credentials }),
        };
...
export type HTTPRequestInit = { headers?: HTTPHeaders | undefined; method: HTTPMethod; credentials?: RequestCredentials | undefined; body?: HTTPBody | undefined };
