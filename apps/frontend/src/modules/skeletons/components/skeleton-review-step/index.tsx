  ...
  return (
    <div className="bg-base-100">
      <div className="flex flex-row items-center justify-between mb-6">
        <div className="w-56 h-7 bg-base-300 animate-pulse" />
      </div>

      <div className="mb-8">
        <div className="bg-base-100 shadow rounded-lg p-6">
          <div className="w-40 h-6 bg-base-300 animate-pulse mb-4" />
          ...
          <div className="mb-6 border-t pt-4">
            <div className="w-48 h-6 bg-base-300 animate-pulse mb-4" />
            <div className="space-y-3">
              {repeat(2).map((i) => (
                ...
                >
                  <div className="w-5 h-5 rounded-full bg-base-300 animate-pulse mt-1" />
                  <div className="flex-1">
                    <div className="w-32 h-5 bg-base-300 animate-pulse mb-2" />
                    <div className="w-48 h-4 bg-base-200 animate-pulse mb-2" />
                    <div className="w-20 h-4 bg-base-300 animate-pulse" />
                  </div>
                </div>
              ))}
            </div>
